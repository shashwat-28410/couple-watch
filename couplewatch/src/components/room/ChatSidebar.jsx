      ...
      <div className="p-5 border-b border-white/5 bg-black/40 backdrop-blur-md flex items-center justify-between">
        <div className="flex items-center gap-6">
          <button 
            ...
            className={`text-[10px] font-black uppercase tracking-[0.3em] italic transition-all ${activeTab === "chat" ? "text-rose-500 scale-105" : "text-[#8B8B9A] hover:text-white/70"}`}
          >
            Heartbeat Chat
          </button>
          <button 
            onClick={() => setActiveTab("memories")}
            className={`text-[10px] font-black uppercase tracking-[0.3em] italic transition-all ${activeTab === "memories" ? "text-rose-500 scale-105" : "text-[#8B8B9A] hover:text-white/70"}`}
          >
            Memories
          </button>
        </div>
